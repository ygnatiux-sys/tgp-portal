...
const commonSchema = z.object({
  ...
  hero_image: z.string().optional().default('https://storage.thegreatpuzzleproject.com/default-hero.webp'),
...
const ensayosFeedSchema = z.object({
  ...
  subtitle: z.string().optional().default(''),
  template: z.string().optional().nullable(),
  coverImage: z.string().optional().default('https://storage.thegreatpuzzleproject.com/default-hero.webp'),
